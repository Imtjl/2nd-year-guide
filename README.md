...
> [!NOTE] Формат курса может отличаться от года к году
...
на другие семинары к другим, задаете вопросики.

### 2 лаба, эссе

Пишете эссе по статье, ревьюите другим, скорее формальность, чем работа.
...
алгоритм на местном ассемблере, защищаете (1 арх-а за подход). По варианту надо
нарисовать схему процессора. Сложность выполнения зависит от попавшихся
вариантов, но в любом случае не запредельна.

### 4 лаба, эксперимент

Разрабатываете по варианту кастомный язык, пишете для него транслятор и
процессор на любом языке. Полезно, но сильно сложнее и объемнее других лаб
...
- Сдавайте лабы как можно раньше (иначе может произойти ряд приколов)
  ...
  - Под конец сема приоритет предоставляется людям, сдающим 4 лабу (но 4 лаба не
    обязательно КТ, а вот 3-я - да). Среднее время проверки одного человека с 4
    лабой - 20-30 мин
...
- Все что расходится с ее лекциями, не принимается, даже если по факту это то же
  самое (shout out метод половинного деления)
- Смотрите слайды лекций, делайте, объясняйте как в них
- В лабах в коде проверяет обычно только условия остановки (не реализацию, а
  наличие)
- Не пропускайте праки, они расчитаны впритык чтобы сдать лабы с первого раза
- Досдавать можно или на лекциях, или на консультациях, они раз в неделю (смотри
  расписание консультаций селиной в ису), в мае их обычно больше (но места
  ограничиваются по записи), на сессии их обычно не больше 2
- Не отлетайте на допсу - гемор
- Кр пишутся на лекции, задания присылаются в ису, пишете с компами, задания
  обычно не меняются, вариант по номеру ису, перепись на праках другой группы

Селина в целом противная, так что запаситесь терпением и не филоньте (сэкономите
время и силы), на деле материал легкий
